...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1541: (o, p) => p in o,
      _1542: (o, p) => o[p],
      _1559: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1560: (x0,x1,x2) => x0.fetch(x1,x2),
      _1561: (x0,x1) => x0.get(x1),
      _1562: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1562(f,arguments.length,x0,x1,x2) }),
      _1563: (x0,x1) => x0.forEach(x1),
      _1564: x0 => x0.abort(),
      _1565: () => new AbortController(),
      ...
      _3528: x0 => x0.navigator,
      _3917: x0 => x0.userAgent,
      _6072: x0 => x0.signal,
      _7908: x0 => x0.value,
      _7910: x0 => x0.done,
      _8612: x0 => x0.url,
